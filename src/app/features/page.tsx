...
export default function FeaturesPage() {
  return <div className="min-h-screen bg-[#f7f6f1] text-[#292b26]"><SiteNav/><main>
    <section className="border-b border-[#d9d8d2] bg-[#f3f2ed]"><div className="container grid gap-12 py-14 sm:py-20 lg:grid-cols-[0.68fr_1.32fr] lg:items-center"><div><p className="text-[10px] uppercase tracking-[0.16em] text-[#697363]">ClientFold in motion</p><h1 className="mt-5 max-w-lg text-balance text-5xl font-medium leading-[0.93] tracking-[-0.06em] sm:text-7xl">Every stuck project has a next move. <span className="font-editorial font-normal italic text-[#5d6857]">Now it finds itself.</span></h1><p className="mt-6 max-w-md text-sm leading-7 text-[#71736b]">See how one request becomes a polite reminder, a clear client action and a project that keeps moving.</p><div className="mt-7 flex flex-wrap gap-3"><TrackedButtonLink placement="features_hero" href="/waitlist" size="lg" className="bg-[#2d302a]">Get early access →</TrackedButtonLink><TrackedButtonLink placement="features_demo" href="/demo" size="lg" variant="outline">Try the demo</TrackedButtonLink></div></div><AutopilotHero/></div></section>
